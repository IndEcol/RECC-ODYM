...
ProjectSpecs_Name_ConFile = 'RECC_Config_V2_2.xlsx'
...
if Name_Script != 'RECC_G7IC_V2_2':  # Name of this script must equal the specified name in the Excel config file

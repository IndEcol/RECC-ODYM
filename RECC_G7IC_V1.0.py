...
GHGEnergySupplyFull = np.einsum('XnSt,r->XnSrt',ParameterDict[PL_Names[index]].Values.copy(),np.ones(14))
...
for mS in range(0,NS):
    for mR in range(0,NR):
        ...
        RECC_System.FlowDict['F_4_7'] = msc.Flow(Name='primary material consumption' , P_Start = 4, P_End = 7, 
                                                 Indices = 't,m,e', Values=None, Uncert=None, 
                                                 Color = None, ID = None, UUID = None)
        
        RECC_System.FlowDict['F_7_8'] = msc.Flow(Name='manufacturing output' , P_Start = 7, P_End = 8, 
                                                 Indices = 't,g,m,e', Values=None, Uncert=None, 
                                                 Color = None, ID = None, UUID = None)
            
        RECC_System.FlowDict['F_8_9'] = msc.Flow(Name='Final consumption', P_Start=8, P_End=9,
                                                 Indices='t,r,g,m,e', Values=None, Uncert=None,
                                                 Color=None, ID=None, UUID=None)
        
        RECC_System.FlowDict['F_9_10'] = msc.Flow(Name='EoL products' , P_Start = 9, P_End = 10, 
                                                 Indices = 't,c,r,g,m,e', Values=None, Uncert=None, 
                                                 Color = None, ID = None, UUID = None)
        
        RECC_System.FlowDict['F_10_0'] = msc.Flow(Name='Obsolete stock formation' , P_Start = 10, P_End = 0, 
                                                 Indices = 't,r,g,m,e', Values=None, Uncert=None, 
                                                 Color = None, ID = None, UUID = None)
        
        RECC_System.FlowDict['F_10_11'] = msc.Flow(Name='Waste mgt. input' , P_Start = 10, P_End = 11, 
                                                 Indices = 't,r,g,m,e', Values=None, Uncert=None, 
                                                 Color = None, ID = None, UUID = None)
        
        RECC_System.FlowDict['F_10_15'] = msc.Flow(Name='Product re-use in' , P_Start = 10, P_End = 15, 
                                                 Indices = 't,r,g,m,e', Values=None, Uncert=None, 
                                                 Color = None, ID = None, UUID = None)
        
        RECC_System.FlowDict['F_15_8'] = msc.Flow(Name='Product re-use out' , P_Start = 15, P_End = 8, 
                                                 Indices = 't,r,g,m,e', Values=None, Uncert=None, 
                                                 Color = None, ID = None, UUID = None)
        
        RECC_System.FlowDict['F_11_12'] = msc.Flow(Name='old scrap' , P_Start = 11, P_End = 12, 
                                                 Indices = 't,r,w,e', Values=None, Uncert=None, 
                                                 Color = None, ID = None, UUID = None)
        
        RECC_System.FlowDict['F_7_12'] = msc.Flow(Name='New scrap' , P_Start = 7, P_End = 12, 
                                                 Indices = 't,r,w,e', Values=None, Uncert=None, 
                                                 Color = None, ID = None, UUID = None)
        
        RECC_System.FlowDict['F_12_11'] = msc.Flow(Name='scrap use' , P_Start = 12, P_End = 11, 
                                                 Indices = 't,r,w,e', Values=None, Uncert=None, 
                                                 Color = None, ID = None, UUID = None)
        
        RECC_System.FlowDict['F_11_6'] = msc.Flow(Name='secondary material production' , P_Start = 11, P_End = 6, 
                                                 Indices = 't,r,m,e', Values=None, Uncert=None, 
                                                 Color = None, ID = None, UUID = None)
        
        RECC_System.FlowDict['F_6_7'] = msc.Flow(Name='secondary material consumption' , P_Start = 6, P_End = 7, 
                                                 Indices = 't,r,m,e', Values=None, Uncert=None, 
                                                 Color = None, ID = None, UUID = None)
        
        RECC_System.FlowDict['F_11_0'] = msc.Flow(Name='waste mgt. and remelting losses' , P_Start = 11, P_End = 0, 
                                                 Indices = 't,r,e', Values=None, Uncert=None, 
                                                 Color = None, ID = None, UUID = None)
        
        # Define system variables: Stocks.
        RECC_System.StockDict['S_9']   = msc.Stock(Name='In-use stock', P_Res=9, Type=1,
                                                 Indices = 't,c,r,g,m,e', Values=None, Uncert=None,
                                                 ID=None, UUID=None)
        ...
        Inflow_Detail_UsePhase      = np.zeros((Nt,Ng,Nr)) # index structure: tgrS
        ...
        for g in tqdm(range(0, Ng), unit=' commodity groups'):
            for r in range(0, Nr):
                ...
                # np.fill_diagonal(SF_Array[:, :, g, r],1) # no outflows from current year, this would break the mass balance in the calculation routine below.
        ...
        for G in tqdm(range(0, NG), unit=' commodity groups'):
            for r in range(0,Nr):   
                ...
                Stock_Detail_UsePhase[1::,:,:,r]   += Var_S.copy()
                Outflow_Detail_UsePhase[1::,:,:,r] += Var_O.copy()
                Inflow_Detail_UsePhase[1::,:,r]    += Var_I[SwitchTime::,:].copy()
        ...
        if ScriptConfig['Include_REStrategy_LightWeighting'] == 'True':
            Par_RECC_MC[SwitchTime-1::,:,:,:] = np.einsum('cmgr,crg->cmgr',Par_RECC_MC[SwitchTime-1::,:,:,:], 1 - np.einsum('cr,gr->crg',RECC_System.ParameterDict['3_SHA_RECC_REStrategyScaleUp_SSP_32R'].Values[mR,:,:,mS]*0.01,RECC_System.ParameterDict['6_PR_LightWeighting_USA'].Values[:,:,mS]))
        ...
        Par_Element_Composition_of_Materials = np.zeros((Nc,Nr,Ng,Nm,Ne)) # crgme
        Par_Element_Composition_of_Materials[0:Nc-Nt+1,:,:,:,:,] = np.einsum('crg,me->crgme',np.ones((Nc -Nt +1,Nr,Ng)),RECC_System.ParameterDict['3_MC_Elements_Materials_ExistingStock'].Values)
        
        # know total inflows and outflows by material, need to split them into elements later:
        RECC_System.FlowDict['F_8_9'].Values[:,:,:,:,0]   = \
        np.einsum('tmgr,tgr->trgm',Par_RECC_MC[SwitchTime-1::,:,:,:],Inflow_Detail_UsePhase)/1000 # Indices='t,r,g,m,e'
        
        # Memory-intensive:
        RECC_System.FlowDict['F_9_10'].Values[:,:,:,:,:,0] = \
        np.einsum('cmgr,tcgr->tcrgm',Par_RECC_MC,Outflow_Detail_UsePhase)/1000
        # 1) expand chemical elements of outflow:
        RECC_System.FlowDict['F_9_10'].Values[0:2,0:Nc-Nt+1,:,:,:,1::] = np.einsum('tcrgm,crgme->tcrgme',RECC_System.FlowDict['F_9_10'].Values[0:2,0:Nc-Nt+1,:,:,:,0],Par_Element_Composition_of_Materials[0:Nc-Nt+1,:,:,:,1::])
        
        # Memory-intensive:
        RECC_System.StockDict['S_9'].Values[:,:,:,:,:,0]   = \
        np.einsum('cmgr,tcgr->tcrgm',Par_RECC_MC,Stock_Detail_UsePhase)/1000
        ...
        if ScriptConfig['Include_REStrategy_EoL_RR_Improvement'] == 'True':
            Par_RECC_EoL_RR_USA =  np.einsum('t,grmw->trmgw',np.ones((Nt)),RECC_System.ParameterDict['4_PY_EoL_RR_USA'].Values[:,:,:,:,0] *0.01) \
        ...
        SysVar_IndirectGHGEms_EnergySupply      = 0.001 * np.einsum('XnSt,trnSR->XtrSR',RECC_System.ParameterDict['4_PE_GHGIntensityEnergySupply_CDLINKS_MESSAGEix'].Values,SysVar_TotalEnergyDemand)
        # Unit: Mt/yr.

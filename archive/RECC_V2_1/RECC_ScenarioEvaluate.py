...
while ModelEvalListSheet.cell_value(Row, 1) != 'ENDOFLIST':
    ...
    if Setting == 'Cascade_pav':
        ...
        ASummaryV, AvgDecadalEmsV, MatSummaryV, AvgDecadalMatEmsV = RECC_G7IC_Cascade_PassVehicles_V2_0.main(RegionalScope,PassVehList)
    ...
    if Setting == 'Cascade_reb':
        ...
        # run the ODYM-RECC scenario comparison
        ASummaryB, AvgDecadalEmsB, MatSummaryB, AvgDecadalMatEmsB = RECC_G7IC_Cascade_ResBuildings_V2_0.main(RegionalScope,ResBldsList)
        # write results summary to Excel
    ...
    if Setting == 'Sensitivity_pav':
        ...
        CumEmsV_Sens, AnnEmsV2030_Sens, AnnEmsV2050_Sens, AvgDecadalEms, MatCumEmsV_Sens, MatAnnEmsV2030_Sens, MatAnnEmsV2050_Sens, MatAvgDecadalEmsV = RECC_G7IC_Sensitivity_PassVehicles_V2_0.main(RegionalScope,PassVehList)        
        # write results summary to Excel
    ...
    if Setting == 'Sensitivity_reb':
        ...
        CumEmsB_Sens, AnnEmsB2030_Sens, AnnEmsB2050_Sens, AvgDecadalEms, MatCumEmsB_Sens, MatAnnEmsB2030_Sens, MatAnnEmsB2050_Sens, MatAvgDecadalEmsB = RECC_G7IC_Sensitivity_ResBuildings_V2_0.main(RegionalScope,ResBldsList)        
        # write results summary to Excel
        Ssheet = mywb['Sensitivity_' + RegionalScope]
        print(RegionalScope)
        for r in range(0,3):
